...
export interface HardcardTimelockControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "emergencyUpdateDelay",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "emergencyVeto",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "rootOwner", values?: undefined): string;
  encodeFunctionData(
...
export namespace EmergencyVetoEvent {
  export type InputTuple = [proposalId: BytesLike, vetoer: AddressLike];
  export type OutputTuple = [proposalId: string, vetoer: string];
  export interface OutputObject {
    proposalId: string;
    vetoer: string;
  }
...
export namespace RootOwnerTransferredEvent {
...
export interface HardcardTimelockController extends BaseContract {
  connect(runner?: ContractRunner | null): HardcardTimelockController;
  waitForDeployment(): Promise<this>;

  interface: HardcardTimelockControllerInterface;
  ...
  DEFAULT_DELAY: TypedContractMethod<[], [bigint], "view">;
  ...
  emergencyUpdateDelay: TypedContractMethod<
    [newDelay: BigNumberish],
    [void],
    "nonpayable"
  >;

  emergencyVeto: TypedContractMethod<[id: BytesLike], [void], "nonpayable">;
  ...
  rootOwner: TypedContractMethod<[], [string], "view">;
  ...
  transferRootOwnership: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "emergencyUpdateDelay"
  ): TypedContractMethod<[newDelay: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "emergencyVeto"
  ): TypedContractMethod<[id: BytesLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "transferRootOwnership"
  ...
  getEvent(
    ...
    EmergencyVetoEvent.InputTuple,
    EmergencyVetoEvent.OutputTuple,
    EmergencyVetoEvent.OutputObject
  >;
  getEvent(
    key: "MinDelayChange"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "RootOwnerTransferred"
  ): TypedContractEvent<
    RootOwnerTransferredEvent.InputTuple,
    RootOwnerTransferredEvent.OutputTuple,
    RootOwnerTransferredEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "EmergencyVeto(bytes32,address)": TypedContractEvent<
      EmergencyVetoEvent.InputTuple,
      EmergencyVetoEvent.OutputTuple,
      EmergencyVetoEvent.OutputObject
    >;
    EmergencyVeto: TypedContractEvent<
      EmergencyVetoEvent.InputTuple,
      EmergencyVetoEvent.OutputTuple,
      EmergencyVetoEvent.OutputObject
    >;
    ...
    "RootOwnerTransferred(address,address)": TypedContractEvent<
      RootOwnerTransferredEvent.InputTuple,
      RootOwnerTransferredEvent.OutputTuple,
      RootOwnerTransferredEvent.OutputObject
    >;
    RootOwnerTransferred: TypedContractEvent<
      RootOwnerTransferredEvent.InputTuple,
      RootOwnerTransferredEvent.OutputTuple,
      RootOwnerTransferredEvent.OutputObject
    >;
