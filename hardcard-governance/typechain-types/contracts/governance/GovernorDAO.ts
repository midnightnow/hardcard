...
export interface GovernorDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "TOTAL_MEMBERS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GovernorDAO extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorDAO;
  waitForDeployment(): Promise<this>;

  interface: GovernorDAOInterface;
  ...
  TOTAL_MEMBERS: TypedContractMethod<[], [bigint], "view">;
