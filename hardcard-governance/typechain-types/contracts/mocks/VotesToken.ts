...
export interface VotesTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface VotesToken extends BaseContract {
  connect(runner?: ContractRunner | null): VotesToken;
  waitForDeployment(): Promise<this>;

  interface: VotesTokenInterface;
